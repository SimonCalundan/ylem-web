    ...
    <>
      ...
      <motion.div className=" text-white w-screen h-auto flex flex-col pt-24">
        ...
        <div className="w-screen h-96 max-h-[40vh] relative">
          ...
          <div className="w-screen h-96 faq-bg opacity-50" />
        </div>
        {/* Content  */}
        <motion.div className=" w-[1080px] max-w-full mx-auto flex flex-col items-start py-16 px-2">
          ...
          <p className="text-body text-base font-light tracking-wider text-gray-300 ml-4">Yes. if your order is yet to be shipped, you can cancel the order and we will refund the whole amount. If your order has already been shipped, you cannot cancel it, and will have to process a return instead.</p>
